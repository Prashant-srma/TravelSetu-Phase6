  ...
  return (
    <main className="min-h-[65vh] bg-[#f7faff] py-20">
      <div className="container-page mx-auto max-w-lg rounded-[28px] border border-[#e4ebf3] bg-white p-8 text-center shadow-travel">
        <h1 className="text-3xl font-black text-[#10243e]">Demo Sign Up</h1>
        <p className="mt-3 text-sm leading-6 text-[#6d7c90]">The localStorage-based demo session is intentionally reserved for a later phase.</p>
